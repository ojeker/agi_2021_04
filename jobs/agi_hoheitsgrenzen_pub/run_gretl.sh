...
/bin/bash ~/Dokumente/git/agi/jobs/start-gretl.sh --docker-image sogis/gretl-runtime:production --job-directory ~/Dokumente/git/gretljobs/agi_hoheitsgrenzen_pub/
